...
class AddTeamViewController: BaseViewController {
    ...
    private let pageTitle = UILabel(text: "Add new team",
                                    textColor: .white,
    ...
    override func setupViewModel() {
        ...
        self.viewModel?.addTeam(model: .init(image: UIImage(named: "addImage")!,
                                             name: "a",
                                             country: "b"))
...
extension AddTeamViewController: UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
